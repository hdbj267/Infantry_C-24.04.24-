...
*/
	...
	.yaw_pid.position.kp = 18,//60
	.yaw_pid.position.ki = 0,
	.yaw_pid.position.kd = 330,//3000
	.yaw_pid.position.a = 0.95,
	.yaw_pid.position.ioutput_max = 1000,
	.yaw_pid.position.output_max = 10000,
	.yaw_pid.position.mode = PID_POSITION,	
	
	.yaw_pid.speed.kp = 290,//303
	.yaw_pid.speed.ki = 0,
	.yaw_pid.speed.kd = 0,
...
* @note    
*/
	.pitch_pid.position.kp =25,//150
	.pitch_pid.position.ki = 0,//0.15
	.pitch_pid.position.kd = 0,//5000
	.pitch_pid.position.a = 0.95,
...
//	.pitch_pid.position.mode = PID_POSITION,
	...
	.pitch_pid.speed.kp = 230,//30
	.pitch_pid.speed.ki = 0,//
...
* @note    
*/
	.trigger_pid.position.kp = 30.0,//30越大，连续发射越快，后面要用时间控制发射速度
