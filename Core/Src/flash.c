...
//	FLASH->KEYR = FLASH_KEY2;
	...
	flash_erase_init.Sector = FLASH_SECTOR_10;//扇区10
...
//	HAL_FLASH_Unlock();
	HAL_FLASHEx_Erase(&flash_erase_init, &sector_error);
//	HAL_FLASH_Lock();
    FLASH_WaitForLastOperation(50000);
//	HAL_FLASH_Lock();	
}
...
//	HAL_FLASH_Unlock();
	FLASH_WaitForLastOperation(50000);
	HAL_FLASH_Program(FLASH_TYPEPROGRAM_WORD, 0x080C0000, (uint32_t)i++);
	FLASH_WaitForLastOperation(50000);
//	HAL_FLASH_Lock();	
}
