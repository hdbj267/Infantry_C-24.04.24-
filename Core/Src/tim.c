...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = MAGAZINE_CONTROL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(MAGAZINE_CONTROL_GPIO_Port, &GPIO_InitStruct);

  /* USER CODE BEGIN TIM1_MspPostInit 1 */
    HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_1);//open PWM1 
    pwm1_off();
  ...
  /* USER CODE BEGIN TIM4_MspPostInit 1 */
    HAL_TIM_PWM_Start(&htim4, TIM_CHANNEL_3);//open PWM1      关了不哔哔！  *hyj
    buzzer_off();
  ...
  /* USER CODE BEGIN TIM10_MspPostInit 1 */
    HAL_TIM_PWM_Start(&htim10, TIM_CHANNEL_1);  //open PWM1
...
/**********TIM3******************/
volatile uint64_t freertos_run_time = 0;
void freertos_run_tim3_configuration(void)
{
	freertos_run_time = 0;
	MX_TIM3_Init();
